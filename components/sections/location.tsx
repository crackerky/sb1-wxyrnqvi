  ...
  return (
    <section id="location" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">アクセス案内</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <div className="bg-white p-8 rounded-lg shadow-lg h-full">
              <h3 className="text-2xl font-semibold mb-6">施設情報</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      土曜: 10:00〜19:00<br />
                      日曜: 10:00〜18:00<br />
                      <span className="text-sm">※祝日は日曜日と同じ営業時間となります</span>
                    </p>
                  </div>
                </div>

                <div className="flex items-start">
                  <Train className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
                  <div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <h4 className="font-medium mb-3">設備について</h4>
                <p className="text-gray-600">
